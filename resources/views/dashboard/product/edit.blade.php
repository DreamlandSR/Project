    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                <form method="POST" action="{{ route('products.update', $product->id) }}" class="p-4 bg-white shadow rounded" style="max-width: 600px;">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="stok_id" name="stok_id" value="{{ $product->stok_id }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="status" name="status" required>
                            ...
                            <option value="unavailable" {{ $product->status == 'unavailable' ? 'selected' : '' }}>Habis</option>
                        </select>
                    </div>

                    <div class="mb-3">
                        <label for="rating" class="form-label">Rating (opsional)</label>
                        <input type="number" class="form-control" id="rating" name="rating" step="0.1" value="{{ $product->rating }}">
                    </div>
